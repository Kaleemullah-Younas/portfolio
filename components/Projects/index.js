...
function Projects() {
    ...
    return (
        <div className="projectCont w-full h-auto relative top-[50px] p-10px flex flex-col items-center justify-center mb-[50px]">
            ...
            <div className="projects w-full h-auto p-3 flex flex-wrap items-center justify-between gap-5 mb-[50px]">
                {projects.slice(0, 4).map((list, i) => (
                    <div
                        ...
                        <div className="w-full p-[10px]">
                            ...
                            {list.project_url && (
                                <a href={list.project_url} target="_blank" className="absolute right-[10px] bottom-[10px] text-white-200 hover:underline">
                                    View <FaArrowRight className="inline ml-2 text-[12px]" />
                                </a>
                            )}
                        </div>
                    </div>
